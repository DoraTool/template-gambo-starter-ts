      ...
      matchUtilities(
        {
          'game-pixel-container-clickable': (value) => {
            return {
              'border-image-source': 'url("/assets/ui/pixel_style/container_pixel_clickable.png")',
        ...
        matchUtilities(
          {
            'game-pixel-container': (value) => {
              return {
                'border-image-source': 'url("/assets/ui/pixel_style/container_pixel.png")',
      ...
      matchUtilities(
        {
          'game-pixel-container-slot': (value) => {
            return {
              'border-image-source': 'url("/assets/ui/pixel_style/container_pixel_slot.png")',
              'border-image-slice': '12 fill',
              'border-image-width': '12px',
              'border-image-repeat': 'stretch',
        ...
        matchUtilities(
          {
            'game-3d-container': (value) => {
              return {
                'border-image-source': 'url("/assets/ui/3d_style/container_3d.png")',
                ...
                'clip-path': 'rect(0px 100% calc(100% + 3px) 0px round 12px) !important',
                'background-color': value,
      ...
      matchUtilities(
        {
          'game-3d-container-clickable': (value) => {
            return {
              'border-image-source': 'url("/assets/ui/3d_style/container_3d_clickable.png")',
              'border-image-slice': '42 42 60 42 fill !important',
              'border-image-width': '14px 14px 20px 14px !important',
              'border-image-repeat': 'stretch !important',
              'border-image-outset': '0px 0px 6px 0px !important',
              'clip-path': 'rect(0px 100% calc(100% + 6px) 0px round 12px) !important',
              'box-shadow': `0px 6px ${value} !important`,
              'background-color': value,
              'margin-bottom': '6px !important',
            }
      ...
      matchUtilities(
        {
          'game-3d-container-slot': (value) => {
            return {
              'border-image-source': 'url("/assets/ui/3d_style/container_3d_slot.png")',
